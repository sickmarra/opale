    ...
    <div className="min-h-dvh bg-bg bg-opale-gradient flex flex-col items-center justify-center px-4">
      <div className="text-center space-y-6 max-w-sm">
        ...
        <div className="space-y-1 pt-4">
          <p className="font-body text-[9px] text-muted tracking-[0.25em] uppercase">Pagina non trovata</p>
          <h1 className="font-heading text-6xl font-light text-text">404</h1>
